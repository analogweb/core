...
public class MultipartParameterResolverTest {
    ...
    public void testGetBinary() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        File actual = (File) resolver.resolveValue(request, metadata, "datafile3", File.class, null);
    ...
    public void testGetField() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        Multipart actual = (Multipart) resolver.resolveValue(request, metadata, "field1", Multipart.class, null);
    ...
    public void testGetFieldAsString() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        String actual = (String) resolver.resolveValue(request, metadata, "field1", String.class, null);
    ...
    public void testGetMultiple() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        Multipart[] actual = (Multipart[]) resolver.resolveValue(request, metadata, "datafile2", Multipart[].class,
                null);
    ...
    public void testGetMultipleField() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        Multipart[] actual = (Multipart[]) resolver.resolveValue(request, metadata, "field2", Multipart[].class, null);
    ...
    public void testGetMultipleFieldAsString() throws Exception {
        ...
        when(request.getContentType()).thenReturn(
                MediaTypes.valueOf("multipart/form-data; boundary=---------------------------287032381131322"));
        String[] actual = (String[]) resolver.resolveValue(request, metadata, "field2", String[].class, null);
