...
public final class RootModulesConfig extends AbstractModulesConfig {
    ...
    public ModulesBuilder prepare(ModulesBuilder builder) {
        ...
        return builder.setModulesProviderClass(StaticMappingContainerAdaptorFactory.class)
                ...
                .setResponseHandlerClass(ResponseHandler.class).setRenderableResolverClass(RenderableResolver.class)
                .setExceptionHandlerClass(ExceptionHandler.class).setTypeMapperContextClass(TypeMapperContext.class)
