...
public class BeanAttributeArgumentPreparatorTest {
    ...
    public void test() throws Exception {
        ...
        when(resolver.resolveValue(context, metadata, "name", String.class, anns)).thenReturn(
                "Name");
        when(resolver.resolveValue(context, metadata, "birthDay", Date.class, anns)).thenReturn(
                "2013-01-01");
        when(resolver.resolveValue(context, metadata, "number", Integer.class, anns)).thenReturn(
                "5");
        ...
        Method method = Resource.class.getDeclaredMethod("doSomething", SomeBean.class,
                String.class);
