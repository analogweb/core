...
public class DefaultExceptionHandlerTest {
    ...
    public void setUp() {
        ...
        when(modules.getExceptionMappers())
                .thenReturn(Arrays.<ExceptionMapper> asList(new UnsupportedMediaTypeExceptionMapper(),
                        new InvalidRequestFormatExceptionMapper(), new RequestMethodUnsupportedExceptionMapper()));
    ...
    public void testHandleThrowableWithRequestPathUnsupportedException() throws Exception {
        ...
        Object actual = handler
                .handleException(new RequestMethodUnsupportedException(metadata, Arrays.asList("GET"), "POST"));
    ...
    public void testHandleRouteThrowableWithApplicationRuntimeException() throws Exception {
        ...
        Object actual = handler
                .handleException(new InvocationFailureException(new SomeException(), metadata, new String[0]));
        assertThat((HttpStatus) actual, is(HttpStatus.INTERNAL_SERVER_ERROR));
    }
