...
public class AutoTypeMapperTest {
	...
	public void testMapToType() {
		String actual = (String) typeMapper
				.mapToType("foo", String.class, null);
	...
	public void testMapToTypeToCharactor() throws Exception {
		Character actual = (Character) typeMapper.mapToType("ab",
		...
		char actualChar = (Character) typeMapper.mapToType(null, char.class,
				null);
	...
	public void testMapToTypeToShort() throws Exception {
		...
		assertNull(actual);
		short actualShort = (Short) typeMapper.mapToType(null, short.class,
				null);
		...
		assertNull(actual);
		actual = (Short) typeMapper
				.mapToType("Not-A-Number", short.class, null);
		assertNull(actual);
	}

	@Test
	public void testMapToTypeToDouble() throws Exception {
		Double actual = (Double) typeMapper
				.mapToType("1.0", Double.class, null);
		...
		assertNull(actual);
		double actualDouble = (Double) typeMapper.mapToType(null, double.class,
				null);
		...
		assertNull(actual);
		actual = (Double) typeMapper.mapToType("Not-A-Number", double.class,
				null);
		assertNull(actual);
	}
	...
	public void testMapToTypeToFloat() throws Exception {
		...
		assertNull(actual);
		float actualFloat = (Float) typeMapper.mapToType(null, float.class,
				null);
		...
		assertNull(actual);
		actual = (Float) typeMapper
				.mapToType("Not-A-Number", float.class, null);
		assertNull(actual);
	}

	@Test
	public void testMapToTypeToInteger() throws Exception {
		Integer actual = (Integer) typeMapper.mapToType("1", Integer.class,
				null);
		...
		assertNull(actual);
		actual = (Integer) typeMapper
				.mapToType("Not-A-Number", int.class, null);
		assertNull(actual);
	}
	...
	public void testMapToTypeToDate() throws Exception {
		...
		Date actual = (Date) typeMapper.mapToType("2010-12-09", Date.class,
				null);
		assertThat(actual, is(expected));
		actual = (Date) typeMapper.mapToType("2010-12-09", Date.class,
				new String[0]);
		assertThat(actual, is(expected));
	...
	public void testMapToTypeToBigDecimal() throws Exception {
		BigDecimal actual = (BigDecimal) typeMapper.mapToType("1001.1",
				BigDecimal.class, null);
		assertThat(actual, is(new BigDecimal("1001.1")));
		actual = (BigDecimal) typeMapper.mapToType("1001.1", BigDecimal.class,
				new String[0]);
		assertThat(actual, is(new BigDecimal("1001.1")));
		actual = (BigDecimal) typeMapper.mapToType("57,311,001.11",
	...
	public void testMapToTypeArrayToString() throws Exception {
		String actual = (String) typeMapper.mapToType(new String[]{"a"},
				String.class, null);
		assertThat(actual, is("a"));
		actual = (String) typeMapper.mapToType(new String[]{"a", "b"},
				String.class, null);
		assertThat(actual, is("a"));
		actual = (String) typeMapper.mapToType(new String[0], String.class,
				null);
		assertThat(actual, is(nullValue()));
	}
