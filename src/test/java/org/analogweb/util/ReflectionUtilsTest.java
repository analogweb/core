...
public class ReflectionUtilsTest {
    ...
    public void testGetMethodParameterAnnotation() throws Exception {
        Method doSomething = MockObject.class.getMethod("doSomething", new Class<?>[] { String.class });
        Foo foo = ReflectionUtils.getMethodParameterAnnotation(doSomething, Foo.class, 0);
        assertNotNull(foo);
    }
    ...
    public void testGetMethodParameterAnnotationOutOfIndex() throws Exception {
        Method doSomething = MockObject.class.getMethod("doSomething", new Class<?>[] { String.class });
        Foo foo = ReflectionUtils.getMethodParameterAnnotation(doSomething, Foo.class, 1);
        assertNull(foo);
    }

    @Test
    public void testGetInstanceQuietly() {
        MockObject actual = ReflectionUtils.getInstanceQuietly(MockObject.class);
        assertNotNull(actual);
    }

    @Test
    public void testGetInstanceQuietlyWithNotMatchConstractorArgs() {
        MockObjectWithConstractorArg actual = ReflectionUtils.getInstanceQuietly(MockObjectWithConstractorArg.class);
        assertNull(actual);
    }
    ...
    public void testGetInstanceQuietlyWithPrivateConstractorArgs() {
        ...
        assertNull(actual);
        actual = ReflectionUtils.getInstanceQuietly(MockObjectWithConstractorArg.class, null, "foo");
        assertNull(actual);
    }
    ...
    public void testFilterClassAsImplementsInterface() {
        ...
        List<Class<IIMockObject>> result = ReflectionUtils.filterClassAsImplementsInterface(IIMockObject.class,
                classes);
    ...
    public void testGetValueViaPrivateField() {
        MockObject obj = new MockObject();
        obj.hoge = "foo";
        Object actual = ReflectionUtils.getValueOfField("hoge", Modifier.PRIVATE, obj);
    ...
    public void testGetValueViaNotAvailableField() {
        MockObject obj = new MockObject();
        obj.hoge = "foo";
        Object actual = ReflectionUtils.getValueOfField("noexists", Modifier.PRIVATE, obj);
        assertNull(actual);
    }
    ...
    public void testFindAllImplementsInterfacesRecursivery() {
        Set<Class<?>> actual = ReflectionUtils.findAllImplementsInterfacesRecursivery(MockIIObjectExt.class);
    ...
    public void testFindAllImplementsInterfacesRecursiveryWithObject() {
        Set<Class<?>> actual = ReflectionUtils.findAllImplementsInterfacesRecursivery(Object.class);
        assertTrue(actual.isEmpty());
    }

    @Test
    public void testFindAllImplementsInterfacesRecursiveryWithNull() {
        Set<Class<?>> actual = ReflectionUtils.findAllImplementsInterfacesRecursivery(null);
        assertTrue(actual.isEmpty());
    }
    ...
    public void testGetCallerClass() {
        ...
        assertThat(actual.get(0).getCanonicalName(), is("org.analogweb.util.ReflectionUtilsTest.MockObject"));
    }
