...
public class DefaultModulesBuilder implements ModulesBuilder {
    ...
    @Override
    public Modules buildModules(final ApplicationContext resolver, final ContainerAdaptor defaultContainer) {
        final ContainerAdaptor moduleContainerAdaptor = createModuleContainerAdaptor(resolver, defaultContainer);
        ...
        return new Modules() {
            ...
            public Invoker getInvoker() {
                if (invoker == null) {
                    ...
                    if (invokerFactory == null) {
                        factory = getComponentInstance(moduleContainerAdaptor, getInvokerFactoryClass());
                    } else {
            ...
            public ContainerAdaptor getInvocationInstanceProvider() {
                if (this.instanceProvider == null) {
                    ...
                    if (invocationInstanceProvider == null) {
                        factory = moduleContainerAdaptor.getInstanceOfType(getInvocationInstanceProviderClass());
                    } else {
            ...
            public List<ApplicationProcessor> getApplicationProcessors() {
                if (this.processors == null) {
                    this.processors = getComponentInstances(moduleContainerAdaptor, getApplicationProcessorClasses(),
            ...
            public List<InvocationInterceptor> getInvocationInterceptors() {
                if (this.interceptors == null) {
                    this.interceptors = getComponentInstances(moduleContainerAdaptor, getInvocationInterceptorClasses(),
            ...
            private <T> T getComponentInstance(ContainerAdaptor adaptor, Class<T> componentClass) {
                ...
                if (instance instanceof ModulesContainerAdaptorAware) {
                    ((ModulesContainerAdaptorAware) instance).setModulesContainerAdaptor(getModulesContainerAdaptor());
                }
                Set<String> ai = getAlreadyInjectedTypeNames();
                if (ai.contains(componentClass.getCanonicalName()) == false && instance instanceof ModulesAware) {
            ...
            public RequestValueResolvers getRequestValueResolvers() {
                if (this.resolvers == null) {
                    ...
                    resolverList.addAll(getComponentInstances(moduleContainerAdaptor, getAttributesHandlerClasses()));
                    resolverList
                            .addAll(getComponentInstances(moduleContainerAdaptor, getRequestValueResolverClasses()));
            ...
            public List<ExceptionMapper> getExceptionMappers() {
                if (this.exMappers == null) {
                    this.exMappers = getComponentInstances(moduleContainerAdaptor, getExceptionMapperClasses());
    ...
    @Override
    public ModulesBuilder addResponseFormatters(Class<? extends Renderable> mapToResponseClass,
