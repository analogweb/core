...
public class DefaultModulesBuilder implements ModulesBuilder {
	...
	public Modules buildModules(final ApplicationContext resolver,
		...
		return new Modules() {
			...
			public List<InvocationMetadataFactory> getInvocationMetadataFactories() {
				List<InvocationMetadataFactory> factories = getComponentInstances(
			...
			public List<InvocationMetadataFinder> getInvocationMetadataFinders() {
				if (metadataFinders == null) {
					metadataFinders = getComponentInstances(
							moduleContainerAdaptor,
			...
			public Invoker getInvoker() {
				if (invoker == null) {
					...
					invoker = factory
							.createInvoker(getInvocationInterceptors());
				}
				return invoker;
			}
			...
			public List<ApplicationProcessor> getApplicationProcessors() {
				if (this.processors == null) {
					this.processors = getComponentInstances(
							moduleContainerAdaptor,
			...
			public List<InvocationInterceptor> getInvocationInterceptors() {
				if (this.interceptors == null) {
					this.interceptors = getComponentInstances(
							moduleContainerAdaptor,
			...
			public ResponseFormatter findResponseFormatter(
				...
				ResponseFormatter formatter = responseFormatters
						.get(mapToResponse);
				if (formatter != null) {
					return formatter;
				}
			...
			public RequestValueResolvers getRequestValueResolvers() {
				if (this.resolvers == null) {
					...
					resolverList.addAll(getComponentInstances(
							moduleContainerAdaptor,
							getAttributesHandlerClasses()));
					resolverList.addAll(getComponentInstances(
							moduleContainerAdaptor,
							getRequestValueResolverClasses()));
					this.resolvers = new DefaultReqestValueResolvers(
							resolverList);
				}
				return resolvers;
			}
			...
			public List<ExceptionMapper> getExceptionMappers() {
				if (this.exMappers == null) {
					this.exMappers = getComponentInstances(
							moduleContainerAdaptor, getExceptionMapperClasses());
	...
	protected ContainerAdaptor createModuleContainerAdaptor(
			final ApplicationContext resolver,
			final ContainerAdaptor defaultContainer) {
	...
	// TODO:implement.
	@Override
	public ModulesBuilder setModulesProvider(
	...
	@Override
	public ModulesBuilder addInvocationMetadataFactories(
			InvocationMetadataFactory... invocationMetadataFactories) {
		this.invocationMetadataFactories.addAll(Arrays
				.asList(invocationMetadataFactories));
		return this;
	}
	...
	public ModulesBuilder addInvocationMetadataFinderClass(
		...
		this.invocationMetadataFinderClasses
				.add(actionMethodMetadataFinderClass);
		return this;
	}

	@Override
	public ModulesBuilder addInvocationMetadataFinder(
			InvocationMetadataFinder... invocationMetadataFinder) {
		this.invocationMetadataFinders.addAll(Arrays
				.asList(invocationMetadataFinder));
		return this;
	}
	...
	@Override
	public ModulesBuilder setInvocationInstanceProvider(
	...
	@Override
	public ModulesBuilder setInvocationFactory(
	...
	@Override
	public ModulesBuilder setRenderableResolver(
			RenderableResolver responseResolver) {
	...
	@Override
	public ModulesBuilder setTypeMapperContext(
	...
	@Override
	public ModulesBuilder addApplicationProcessor(
	...
	@Override
	public ModulesBuilder addInvocationInterceptor(
			InvocationInterceptor... invocationInterceptors) {
		this.invocationInterceptors.addAll(Arrays
				.asList(invocationInterceptors));
		return this;
	}
	...
	@Override
	public ModulesBuilder addAttributesHandler(
	...
	@Override
	public ModulesBuilder addRequestValueResolver(
	...
	@Override
	public ModulesBuilder addResponseFormatters(
			Class<? extends Renderable> mapToResponseClass,
	...
	@Override
	public ModulesBuilder addExceptionMapper(
