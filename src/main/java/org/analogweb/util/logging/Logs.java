...
public final class Logs {
    ...
    public static Log getLog(String name, ClassLoader loader, String logImplementationClassName) {
        Log logger = findImplementation(name, loader, logImplementationClassName);
        return logger;
    }

    @SuppressWarnings("unchecked")
    private static Log findImplementation(String name, ClassLoader loader, String logImplementationClassName) {
        try {
            Class<?> implementationClass = ClassUtils.forNameQuietly(logImplementationClassName);
            ...
            return defaultImplementationWithException(name, loader, e, "WU001001", logImplementationClassName);
        } catch (NoSuchMethodException e) {
            return defaultImplementationWithException(name, loader, e, "WU001002", logImplementationClassName);
        } catch (InvocationTargetException e) {
            Throwable cause = e.getCause();
            return defaultImplementationWithException(name, loader, (cause != null) ? cause : e, "WU001003");
        } catch (IllegalAccessException e) {
            return defaultImplementationWithException(name, loader, e, "WU001000");
        } catch (SecurityException e) {
            return defaultImplementationWithException(name, loader, e, "WU001000");
        }
    }

    private static Log defaultImplementationWithException(String name, ClassLoader loader, Throwable e, String message,
            Object... args) {
        Log l = defaultImplementation(name, loader);
