...
public class LogsTest {
	...
	void loadConfig(String logLevel) throws Exception {
		...
		props.put("handlers", LogsTest.class.getCanonicalName()
				+ "$StubHandler," + ConsoleHandler.class.getCanonicalName());
		props.put(".level", logLevel);
		props.put(LogsTest.class.getCanonicalName() + "StubHandler.level",
				logLevel);
	...
	public void testDistinctCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), StubLogImpl.class.getName());
	...
	public void testNoExistsCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), "not.avairable.logClass");
		assertTrue(log instanceof JulLog);
	}
	...
	public void testNoCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), AbstractLog.class.getName());
		assertTrue(log instanceof JulLog);
	}
	...
	public void testNoLogCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), LogsTest.class.getName());
		assertTrue(log instanceof JulLog);
	}
	...
	public void testNoConstractorCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), NoConstractorLogImpl.class.getName());
		assertTrue(log instanceof JulLog);
	}
	...
	public void testNotInstanticatableCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), NoInstanticatableLogImpl.class
				.getName());
		assertTrue(log instanceof JulLog);
	}
	...
	public void testFailInstanticatableCustomLogger() throws Exception {
		loadConfig("FINEST");
		log = Logs.getLog(LogsTest.class.getName(), Thread.currentThread()
				.getContextClassLoader(), FailInstanticatableLogImpl.class
				.getName());
		assertTrue(log instanceof JulLog);
	}
	...
	public static class StubLogImpl extends AbstractLog {
		...
		@Override
		public void log(MessageResource messageResource, Marker marker,
				String message) {
			// nop.
		}
