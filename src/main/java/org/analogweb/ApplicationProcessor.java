...
public interface ApplicationProcessor extends MultiModule, Precedence {
    ...
    /**
     * Interrupt after cause exception when execute {@link Application}.
     * Returns expect {@link #NO_INTERRUPTION}, finish process request with return value.
     * @param ex Caused exception when execute {@link Application}.
    ...
    /**
     * Interrupt after execute {@link Application}.
     * Returns expect {@link #NO_INTERRUPTION}, finish process request with return value.
     ...
     * When {@link #processException(Exception, RequestContext, PreparedInvocationArguments, InvocationMetadata)} returns value,
