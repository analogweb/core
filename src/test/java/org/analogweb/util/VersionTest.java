		...
		ClassLoader classLoader = new URLClassLoader(new URL[0]) {
			...
			public Enumeration<URL> getResources(String name)
				...
				return Thread
						...
						.getResources(
								"org/analogweb/util/VersionTest-1.properties");
			}
		};
						...
						.enumeration(Arrays
								.asList(Thread
										...
										Thread.currentThread()
												.getContextClassLoader()
												.getResource(
														"org/analogweb/util/VersionTest-2.properties")));
			}
		};
		List<Version> actual = Version.load(classLoader);
		assertThat(actual.size(), is(2));
		// Alphabetical order.
		assertThat(actual.get(0).getArtifactId(),
				is("analogweb-another-plugin"));
