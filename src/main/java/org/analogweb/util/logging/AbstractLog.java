...
public abstract class AbstractLog implements Log {
    ...
    @Override
    public void log(MessageResource messageResource, Marker marker, String message, Throwable t,
            Object... args) {
    ...
    protected void logInternal(MessageResource messageResource, Marker marker, String message,
