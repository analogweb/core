...
public class FormParametersTest {
	...
	public void testGetValues() throws Exception {
		...
		InputStream body = new ByteArrayInputStream(
				"foo=baa&hoge=fuga&hoge=hoge%21".getBytes());
		MediaType contentType = MediaTypes.APPLICATION_FORM_URLENCODED_TYPE;
		params = new FormParameters(requestURI,
				DefaultReadableBuffer.readBuffer(body), contentType);
	...
	public void testAsMap() throws Exception {
		...
		InputStream body = new ByteArrayInputStream(
				"%E5%A0%B4%E6%89%80=Tokyo&%E5%90%8D%E5%89%8D=Yukio"
						.getBytes("UTF-8"));
