...
public class JsonTest {
    ...
    public void testSingleObject() throws Exception {
        ...
        assertThat(actual, is("{\"age\": 33,\"birthDay\": " + birthDay.getTime() + ",\"name\": \"foo\"}"));
    ...
    public void testList() throws Exception {
        ...
        List<Simple> beans = Arrays.asList(new Simple("foo", 33, birthDay), new Simple("baa", 32, birthDay2));
        ...
        String actual = new String(body, charset);
        assertThat(actual, is("{[" + "{\"age\": 33,\"birthDay\": " + birthDay.getTime() + ",\"name\": \"foo\"},"
                + "{\"age\": 32,\"birthDay\": " + birthDay2.getTime() + ",\"name\": \"baa\"}" + "]}"));
    }
    ...
    public void testArray() throws Exception {
        ...
        Date birthDay = new SimpleDateFormat("yyyyMMdd").parse("20110420");
        Date birthDay2 = new SimpleDateFormat("yyyyMMdd").parse("20110712");
        Simple[] beans = new Simple[] { new Simple("foo", 33, birthDay), new Simple("baa", 32, birthDay2) };
        Json json = Json.as(beans);
        assertThat(json.resolveContentType(), is("application/json; charset=" + charset));
        assertThat(json.getCharsetAsText(), is(charset));
        Headers headers = mock(Headers.class);
    ...
    public void testManyList() throws Exception {
        ...
        assertThat(actual,
                is("{\"boo\": true,\"simples\": [" + "{\"age\": 33,\"birthDay\": " + birthDay.getTime()
    ...
    public void testManyArray() throws Exception {
        ...
        String actual = new String(body, "UTF-8");
        assertThat(actual,
                is("{\"id\": \"01\",\"simples\": [" + "{\"age\": 33,\"birthDay\": " + birthDay.getTime()
                        + ",\"name\": \"foo\"}," + "{\"age\": 32,\"birthDay\": " + birthDay2.getTime()
                        + ",\"name\": \"baa\"}" + "]}"));
    }
    ...
    static class ManyList implements Serializable {
        ...
        ManyList() {
            ...
            try {
                simples.add(new Simple("foo", 33, new SimpleDateFormat("yyyyMMdd").parse("20110420")));
                simples.add(new Simple("baa", 32, new SimpleDateFormat("yyyyMMdd").parse("20100712")));
    ...
    static class ManyArray implements Serializable {
        ...
        ManyArray() {
            ...
            try {
                simples[0] = new Simple("foo", 33, new SimpleDateFormat("yyyyMMdd").parse("20110420"));
                simples[1] = new Simple("baa", 32, new SimpleDateFormat("yyyyMMdd").parse("20100712"));
            } catch (ParseException e) {
                // nop.
            }
        }
