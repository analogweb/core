...
public class AnnotationInvocationMetadataFactoryTest {
	...
	public void testDetectAnnotatedAction() throws Exception {
		...
		Method actionMethod = FooResource.class.getMethod("doSomething",
				(Class[]) null);
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
	...
	@Test
	public void testDetectAnnotatedActionWithoutTypePathMapping()
			throws Exception {
	...
	public void testDetectAnnotatedActionWithPostMethod() throws Exception {
		...
		Method actionMethod = BaaResource.class.getMethod(
				"doSomethingWithPostMethod", (Class[]) null);
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
		...
		assertThat(actionMethodMetadata.getArgumentTypes().length, is(0));
		assertThat(actionMethodMetadata.getMethodName(),
	...
	public void testDetectAnnotatedActionWithGetMethod() throws Exception {
		Class<?> actionsClass = BaaResource.class;
		Method actionMethod = BaaResource.class.getMethod(
				"doSomethingWithGetMethod", (Class[]) null);
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
	...
	public void testDetectAnnotatedActionWithPutMethod() throws Exception {
		Class<?> actionsClass = BaaResource.class;
		Method actionMethod = BaaResource.class.getMethod(
				"doSomethingWithPutMethod", (Class[]) null);
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
	...
	public void testDetectAnnotatedActionWithDeleteMethod() throws Exception {
		Class<?> actionsClass = BaaResource.class;
		Method actionMethod = BaaResource.class.getMethod(
				"doSomethingWithDeleteMethod", new Class[]{String.class});
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
	...
	public void testDetectAnnotatedActionWithArg() throws Exception {
		...
		assertThat(actionMethodMetadata.getArgumentTypes().length, is(1));
		assertThat(
				actionMethodMetadata.getArgumentTypes()[0].getCanonicalName(),
				is(String.class.getCanonicalName()));
		assertThat(actionMethodMetadata.getMethodName(),
				is("doSomethingWithArg"));
		assertThat(actionMethodMetadata.getDefinedPath().getActualPath(),
	...
	public void testDetectAnnotatedActionNoDetectable() throws Exception {
		Class<?> actionsClass = FooResource.class;
		Method actionMethod = FooResource.class.getMethod(
				"doSomethingNoDetectable", new Class<?>[]{String.class,
						Integer.class});
		assertThat(
				factory.createInvocationMetadata(actionsClass, actionMethod),
				is(nullValue()));
	}

	@Test
	public void testDetectAnnotatedActionWithArgAndPathAutoDetection()
			throws Exception {
		Class<?> actionsClass = FooResource.class;
		Method actionMethod = FooResource.class.getMethod(
				"doSomethingNameBased", new Class<?>[]{String.class});
		InvocationMetadata actionMethodMetadata = factory
				.createInvocationMetadata(actionsClass, actionMethod);
		assertThat(
				actionMethodMetadata.getInvocationClass().getCanonicalName(),
		...
		assertThat(
				...
				is(String.class.getCanonicalName()));
		assertThat(actionMethodMetadata.getMethodName(),
				is("doSomethingNameBased"));
		assertThat(actionMethodMetadata.getDefinedPath().getActualPath(),
				is("/foo/doSomethingNameBased"));
	}

	@Test
	public void testDetectAnnotatedActionWithRootPathAutoDetection()
			throws Exception {
		Class<?> actionsClass = BaaResource.class;
		Method actionMethod = BaaResource.class.getMethod(
				"doSomethingNameBased", new Class<?>[]{String.class});
	...
	public static class FooResource {
		...
		public Renderable doSomethingNoDetectable(String arg,
				@As("foo") Integer foo) {
			return null;
		}
