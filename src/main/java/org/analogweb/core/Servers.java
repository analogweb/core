...
public final class Servers {
    ...
    public static Server create(String uri, String... packageNames) {
        ...
        if (ArrayUtils.isEmpty(packageNames)) {
            ...
            names = StringUtils.join(',', detectedPackages.toArray(new String[detectedPackages.size()]));
        } else {
    ...
    public static Server create(URI uri, ApplicationProperties properties) {
        return create(uri, properties, DefaultApplicationContext.context(Maps.<String, Object> newEmptyHashMap()),
                new WebApplication());
    }

    public static Server create(URI uri, ApplicationProperties properties, ApplicationContext context) {
    ...
    public static Server create(URI uri, ApplicationProperties properties, ApplicationContext context,
        ...
        Class<?> probablyFactoryClass = ClassUtils
                .forNameQuietly(ServerFactory.class.getPackage().getName() + ".ServerFactoryImpl");
    ...
    private static Server createDefaultServer(URI uri, ApplicationProperties properties, ApplicationContext context,
            Application application) {
