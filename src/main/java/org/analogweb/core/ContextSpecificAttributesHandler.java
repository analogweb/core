...
public abstract class ContextSpecificAttributesHandler<T extends RequestContext> extends AbstractAttributesHandler {
    ...
    public final Object resolveValue(RequestContext requestContext, InvocationMetadata metadata, String key,
    ...
    protected Object resolveAttributeValueOnContext(T requestContext, InvocationMetadata metadata, String key,
            Class<?> requiredType) {
        return null;
    }
