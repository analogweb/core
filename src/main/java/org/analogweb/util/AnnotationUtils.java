...
public final class AnnotationUtils {
	...
	public static <T extends Annotation> T findAnnotation(Class<T> target,
		...
		if (Annotation.class.isAssignableFrom(annotationContainsClass)
				&& !annotationContainsClass.getPackage().equals(
						Annotation.class.getPackage())) {
			return findAnnotation(target,
					annotationContainsClass.getAnnotations());
		}
	...
	public static boolean isDeclared(
			Class<? extends Annotation> expectDeclared, Class<?> clazz) {
