...
public final class Logs {
    ...
    private static Log findImplementation(String name, ClassLoader loader,
        ...
        try {
            ...
            return defaultImplementationWithException(name, loader, e, "WU001001",
                    logImplementationClassName);
        } catch (NoSuchMethodException e) {
            return defaultImplementationWithException(name, loader, e, "WU001002",
                    logImplementationClassName);
        } catch (InvocationTargetException e) {
            Throwable cause = e.getCause();
            return defaultImplementationWithException(name, loader, (cause != null) ? cause : e,
                    "WU001003");
    ...
    private static Log defaultImplementationWithException(String name, ClassLoader loader,
            Throwable e, String message, Object... args) {
        Log l = defaultImplementation(name, loader);
