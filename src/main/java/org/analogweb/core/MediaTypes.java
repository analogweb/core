...
public final class MediaTypes {
	...
	/** "application/xml" */
	public final static MediaType APPLICATION_XML_TYPE = new DefaultMediaType(
			"application", "xml");
	/** "application/atom+xml" */
	public final static String APPLICATION_ATOM_XML = "application/atom+xml";
	/** "application/atom+xml" */
	public final static MediaType APPLICATION_ATOM_XML_TYPE = new DefaultMediaType(
			"application", "atom+xml");
	/** "application/xhtml+xml" */
	public final static String APPLICATION_XHTML_XML = "application/xhtml+xml";
	/** "application/xhtml+xml" */
	public final static MediaType APPLICATION_XHTML_XML_TYPE = new DefaultMediaType(
			"application", "xhtml+xml");
	/** "application/svg+xml" */
	public final static String APPLICATION_SVG_XML = "application/svg+xml";
	/** "application/svg+xml" */
	public final static MediaType APPLICATION_SVG_XML_TYPE = new DefaultMediaType(
			"application", "svg+xml");
	/** "application/json" */
	public final static String APPLICATION_JSON = "application/json";
	/** "application/json" */
	public final static MediaType APPLICATION_JSON_TYPE = new DefaultMediaType(
			"application", "json");
	/** "application/javascript" */
	public final static String APPLICATION_JAVASCRIPT = "application/javascript";
	/** "application/javascript" */
	public final static MediaType APPLICATION_JAVASCRIPT_TYPE = new DefaultMediaType(
			"application", "javascript");
	...
	/** "multipart/form-data" */
	public final static MediaType MULTIPART_FORM_DATA_TYPE = new DefaultMediaType(
			"multipart", "form-data");
	...
	/** "text/plain" */
	public final static MediaType TEXT_PLAIN_TYPE = new DefaultMediaType(
			"text", "plain");
	/** "text/xml" */
	public final static String TEXT_XML = "text/xml";
	/** "text/xml" */
	public final static MediaType TEXT_XML_TYPE = new DefaultMediaType("text",
			"xml");
	/** "text/html" */
	public final static String TEXT_HTML = "text/html";
	/** "text/html" */
	public final static MediaType TEXT_HTML_TYPE = new DefaultMediaType("text",
			"html");
	/** "text/javascript" */
	public final static String TEXT_JAVASCRIPT = "text/javascript";
	/** "text/javascript" */
	public final static MediaType TEXT_JAVASCRIPT_TYPE = new DefaultMediaType(
			"text", "javascript");
	...
	private static final class DefaultMediaType implements MediaType {
		...
		DefaultMediaType(String type, String subType,
			...
			this.subType = (StringUtils.isEmpty(subType))
					? WILDCARD_VALUE
					: subType;
			this.parameters = (Map<String, String>) ((parameters == null)
					? Maps.newEmptyHashMap()
