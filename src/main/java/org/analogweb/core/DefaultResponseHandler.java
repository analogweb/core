...
public class DefaultResponseHandler implements ResponseHandler {
    ...
    public Response handleResult(Object result,  InvocationMetadata metadata,RenderableResolver renderableResolver,
        ...
        return handleResultInternal(resolved, metadata,renderableResolver,resultFormatter, context, response,exceptionHandler,finder);
    }

    protected Response handleResultInternal(Renderable result,  InvocationMetadata metadata,RenderableResolver renderableResolver,ResponseFormatter resultFormatter,
            RequestContext context, ResponseContext response,ExceptionHandler exceptionHandler,ResponseFormatterFinder finder) throws IOException,
            WebApplicationException {
        try {
            ...
            return handleResult(exceptionHandler.handleException(e), metadata, renderableResolver, context, response, exceptionHandler, finder);
        }
    }
}
