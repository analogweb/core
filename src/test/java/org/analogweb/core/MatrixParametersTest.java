...
public class MatrixParametersTest {
    ...
    @Test
    public void test() {
        URI requestURI = URI.create("http://some.where/thing;paramA=1;paramB=6542");
    ...
    public void testContainsPath() {
        URI requestURI = URI.create("http://example.com/res/categories;name=foo/objects;name=green/?page=1");
        params = new MatrixParameters(requestURI);
