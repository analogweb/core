...
public class AbstractRequestContextTest {
    ...
    public void setUp() throws Exception {
        ...
        context = new StubRequestContext(path, locale, headers, new ByteArrayInputStream("This is test.".getBytes()));
    }

    @Test
	public void testGetContentLength() {
		when(headers.getValues("Content-Length")).thenReturn(
				Arrays.asList("13"));
    ...
    private final class StubRequestContext extends AbstractRequestContext {
        ...
        protected StubRequestContext(RequestPath requestPath, Locale defaultLocale, Headers headers, InputStream in) {
