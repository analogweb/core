...
public final class ResourceUtils {
    ...
    private static final List<ResourceFinder> DEFAULT_STRATEGIES = Arrays.asList(new ResourceFinder[] {
            FindResourceStrategies.CLASSPATH, FindResourceStrategies.URL, FindResourceStrategies.FILE });
    ...
    public static List<URL> findPackageResources(String packageName, ClassLoader classLoader) {
