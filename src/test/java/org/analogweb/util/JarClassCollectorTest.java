...
public class JarClassCollectorTest {
    ...
    public void testCollect() throws Exception {
        ...
        Collection<String> scannedClassNames = classNames(collector.collect("a.b.c",
                ResourceUtils.findPackageResources("a.b.c", smallClassLoader).get(0), smallClassLoader));
        ...
        scannedClassNames = classNames(collector.collect("a.b.d",
                ResourceUtils.findPackageResources("a.b.d", smallClassLoader).get(0), smallClassLoader));
        assertThat(scannedClassNames.size(), is(2));
        assertThat(scannedClassNames.contains("a.b.d.Baa"), is(true));
        assertThat(scannedClassNames.contains("a.b.d.BaaImpl"), is(true));
        scannedClassNames = classNames(collector.collect("a.b.e",
                ResourceUtils.findPackageResources("a.b.e", smallClassLoader).get(0), smallClassLoader));
    ...
    public void testCollectAll() throws Exception {
        ...
        Collection<String> scannedClassNames = classNames(collector
                .collect(ResourceUtils.findPackageResources("a.b.c", smallClassLoader).get(0), smallClassLoader));
    ...
    public void testCollectWithDirectory() throws Exception {
        Collection<Class<?>> collectedClasses = collector.collect(PACKAGE_NAME,
                ResourceUtils.findPackageResources(PACKAGE_NAME, classLoader).get(0), classLoader);
        assertThat(collectedClasses.isEmpty(), is(true));
    }

    @Test
    public void testCollectWithInvalidPackageName() throws Exception {
        Collection<Class<?>> collectedClasses = collector.collect("invalid.package.name", null, classLoader);
        assertThat(collectedClasses.isEmpty(), is(true));
    }
