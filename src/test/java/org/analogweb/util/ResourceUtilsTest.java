...
public class ResourceUtilsTest {
    ...
    public void testFindURLViaClassPathResource() throws Exception {
        URL url = ResourceUtils.findResource(getClass().getCanonicalName().replace(".",
                File.separator)
                + ".class");
    ...
    public void findResources() throws Exception {
        List<URL> found = ResourceUtils.findResources("org/analogweb/core", Thread.currentThread()
