...
public class Json extends TextFormattable<Json> {
    ...
    static class DefaultFormatter implements ResponseFormatter {
        ...
        @Override
        public ResponseEntity formatAndWriteInto(RequestContext request, ResponseContext response, String charset,
                Object source) throws FormatFailureException {
        ...
        private Object readProperty(PropertyDescriptor desc, Object instance) throws FormatFailureException {
            try {
