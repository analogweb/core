...
public class DefaultTypeMapperContextTest {
    ...
    public void testMapToTypeMapperWithCollection() {
        Object actual = context.mapToType(typeMapper.getClass(), Arrays.asList("foo"), List.class, null);
    ...
    public void testMapToTypeMapperWithSubTypeOfCollection() {
        Object actual = context.mapToType(typeMapper.getClass(), Arrays.asList(1L, 2L), List.class, null);
    ...
    public void testMapToTypeMapperWithSingleOfCollection() {
        String actual = context.mapToType(typeMapper.getClass(), Arrays.asList("foo"), String.class, null);
        assertThat(actual, is("foo"));
    }

    @Test
    public void testMapToTypeMapperWithSubTypeSingleOfCollection() {
        Number actual = context.mapToType(typeMapper.getClass(), Arrays.asList(1L), Number.class, null);
        assertThat(actual.longValue(), is(1L));
    }

    @Test
    public void testMapToTypeMapperWithArray() {
        String[] actualArray = context.mapToType(typeMapper.getClass(), new String[] { "foo", "baa" }, String[].class,
                null);
    ...
    public void testMapToTypeMapperWithSingleOfArray() {
        String actual = context.mapToType(typeMapper.getClass(), new String[] { "foo", "baa" }, String.class, null);
        assertThat(actual, is("foo"));
    }

    @Test
    public void testMapToTypeMapperWithSubTypeOfArray() {
        Number[] actualArray = context.mapToType(typeMapper.getClass(), new Long[] { 1L, 2L }, Number[].class, null);
    ...
    public void testMapToTypeMapperWithSingleSubTypeOfArray() {
        Number actual = context.mapToType(typeMapper.getClass(), new Integer[] { 1, 2 }, Number.class, null);
