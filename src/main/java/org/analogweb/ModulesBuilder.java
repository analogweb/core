...
public interface ModulesBuilder {
    ...
    ModulesBuilder setModulesProvider(ContainerAdaptorFactory<? extends ContainerAdaptor> modulesProvider);
    ...
    ModulesBuilder setTypeMapperContextClass(Class<? extends TypeMapperContext> typeMapperContextClass);
    ...
    ModulesBuilder addApplicationProcessorClass(Class<? extends ApplicationProcessor> applicationProcessorClass);
    ...
    ModulesBuilder addRequestValueResolverClass(Class<? extends RequestValueResolver> requestValueResolverClass);
    ...
    ModulesBuilder addResponseFormatters(Class<? extends Renderable> mapToResponseClass,
