 ...
 * @author snowgoose
 */
public class DefaultServletRequestPathMetadata implements ServletRequestPathMetadata {
    ...
    public DefaultServletRequestPathMetadata(HttpServletRequest request) {
