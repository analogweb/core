...
public class DefaultRenderableResolver implements RenderableResolver {
    ...
    @Override
    public Renderable resolve(Object invocationResult, InvocationMetadata metadata, RequestContext context,
    ...
    protected Renderable stringToResponse(String str, InvocationMetadata metadata, RequestContext context) {
