...
public class AnnotationUtilsTest {
    ...
    public void testFindAnnotation() {
        SomeAnnotation actual = AnnotationUtils.findAnnotation(SomeAnnotation.class, SomeClass.class.getAnnotations());
    ...
    public void testFindAnnotationViaType() {
        SomeAnnotation actual = AnnotationUtils.findAnnotation(SomeAnnotation.class, SomeClass.class);
        assertNotNull(actual);
    }

    @Test
    public void testFindAnnotationViaIncludedClass() {
        SomeAnnotation actual = AnnotationUtils.findAnnotation(SomeAnnotation.class, SomeIncludeClass.class);
        assertNotNull(actual);
    }

    @Test
    public void testFindAnnotationViaImplementsClass() {
        SomeAnnotation actual = AnnotationUtils.findAnnotation(SomeAnnotation.class, SomeClassImpl.class);
        assertNotNull(actual);
    }

    @Test
    public void testFindAnnotationNotFound() {
        SomeAnnotation actual = AnnotationUtils.findAnnotation(SomeAnnotation.class, AnyClass.class.getAnnotations());
        assertNull(actual);
    }

    @Test
    public void testFindAnnotationNotFound2() {
        AnyAnnotation actual = AnnotationUtils.findAnnotation(AnyAnnotation.class, AnyClass.class.getAnnotations());
        assertNull(actual);
    }
    ...
    public void testIsDecleared() throws Exception {
        boolean actual = AnnotationUtils.isDeclared(SomeAnnotation.class, SomeAnnotationInclude.class);
