...
public class DefaultModulesBuilderTest {
	...
	public void setUp() {
		...
		adaptor.register(containerAdaptorFactory.getClass(),
		...
		adaptor.register(invocationInterceptor.getClass(),
	...
	public void testBuildModules() {
		...
		assertSame(modules.getInvocationMetadataFactories().get(0),
				invocationMetadataFactory);
		...
		assertSame(modules.getApplicationProcessors().get(0),
				invocationProcessor);
	...
	public void testOptionalModulesFound() {
		...
		when(defaultAdaptor.getInstancesOfType(ApplicationProcessor.class))
	...
	public static class MockContainerAdaptorFactory
		...
		@Override
		public ContainerAdaptor createContainerAdaptor(
	...
	public static class MockModulesProvidingContainerAdaptor
			implements
				ContainerAdaptor {
