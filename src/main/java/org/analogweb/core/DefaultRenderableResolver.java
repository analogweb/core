...
public class DefaultRenderableResolver implements RenderableResolver {
	...
	@Override
	public Renderable resolve(Object invocationResult,
		...
		if (String.class.isAssignableFrom(type)) {
			return stringToResponse((String) invocationResult, metadata,
					context);
		}
		return anyObjectToResponse(invocationResult, metadata, context);
	}

	protected Renderable nullToResponse(InvocationMetadata metadata,
	...
	protected Renderable stringToResponse(String str,
			InvocationMetadata metadata, RequestContext context) {
		return Text.with(str);
	}

	protected Renderable anyObjectToResponse(Object invocationResult,
			InvocationMetadata metadata, RequestContext context) {
