...
public class AnnotationInvocationMetadataFactoryTest {
    ...
    public void testDetectAnnotatedAction() throws Exception {
        ...
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
    ...
    public void testDetectAnnotatedActionWithPostMethod() throws Exception {
        ...
        Method actionMethod = BaaResource.class.getMethod("doSomethingWithPostMethod", (Class[]) null);
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
    ...
    public void testDetectAnnotatedActionWithGetMethod() throws Exception {
        Class<?> actionsClass = BaaResource.class;
        Method actionMethod = BaaResource.class.getMethod("doSomethingWithGetMethod", (Class[]) null);
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(BaaResource.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes().length, is(0));
    ...
    public void testDetectAnnotatedActionWithPutMethod() throws Exception {
        Class<?> actionsClass = BaaResource.class;
        Method actionMethod = BaaResource.class.getMethod("doSomethingWithPutMethod", (Class[]) null);
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(BaaResource.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes().length, is(0));
    ...
    public void testDetectAnnotatedActionWithDeleteMethod() throws Exception {
        Class<?> actionsClass = BaaResource.class;
        Method actionMethod = BaaResource.class.getMethod("doSomethingWithDeleteMethod", new Class[] { String.class });
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(BaaResource.class.getCanonicalName()));
        ...
        assertThat(actionMethodMetadata.getDefinedPath().getActualPath(), is("/baa/something/delete"));
        List<String> requestMethods = ((RequestPathDefinition) actionMethodMetadata.getDefinedPath())
                .getRequestMethods();
        assertThat(requestMethods.size(), is(1));
    ...
    public void testDetectAnnotatedActionWithArg() throws Exception {
        Class<?> actionsClass = FooResource.class;
        Method actionMethod = FooResource.class.getMethod("doSomethingWithArg", new Class<?>[] { String.class });
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(FooResource.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes().length, is(1));
        assertThat(actionMethodMetadata.getArgumentTypes()[0].getCanonicalName(), is(String.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getMethodName(), is("doSomethingWithArg"));
        assertThat(actionMethodMetadata.getDefinedPath().getActualPath(), is("/foo/something/donewitharg"));
    }
    ...
    public void testDetectAnnotatedActionWithArgAndPathAutoDetection() throws Exception {
        Class<?> actionsClass = FooResource.class;
        Method actionMethod = FooResource.class.getMethod("doSomethingNameBased", new Class<?>[] { String.class });
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(FooResource.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes().length, is(1));
        ...
        assertThat(actionMethodMetadata.getDefinedPath().getActualPath(), is("/foo/doSomethingNameBased"));
    }

    @Test
    public void testDetectAnnotatedActionWithRootPathAutoDetection() throws Exception {
        Class<?> actionsClass = BaaResource.class;
        Method actionMethod = BaaResource.class.getMethod("doSomethingNameBased", new Class<?>[] { String.class });
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(),
                is(BaaResource.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes().length, is(1));
        assertThat(actionMethodMetadata.getArgumentTypes()[0].getCanonicalName(), is(String.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getMethodName(), is("doSomethingNameBased"));
        assertThat(actionMethodMetadata.getDefinedPath().getActualPath(), is("/baa/doSomethingNameBased"));
    }
    ...
    public void testDetectAnnotatedActionInhelitance() throws Exception {
        ...
        InvocationMetadata actionMethodMetadata = factory.createInvocationMetadata(actionsClass, actionMethod);
        assertThat(actionMethodMetadata.getInvocationClass().getCanonicalName(), is(Child.class.getCanonicalName()));
        assertThat(actionMethodMetadata.getArgumentTypes()[0].getCanonicalName(), is(String.class.getCanonicalName()));
