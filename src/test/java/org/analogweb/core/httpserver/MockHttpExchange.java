...
public class MockHttpExchange extends HttpExchange {
    ...
    /* (non-Javadoc)
     * @see com.sun.net.httpserver.HttpExchange#sendResponseHeaders(int, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.sun.net.httpserver.HttpExchange#setAttribute(java.lang.String, java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.sun.net.httpserver.HttpExchange#setStreams(java.io.InputStream, java.io.OutputStream)
     */
    @Override
