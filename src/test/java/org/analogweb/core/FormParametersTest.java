...
public class FormParametersTest {
    ...
    public void testGetValues() throws Exception {
        ...
        params = new FormParameters(requestURI, DefaultReadableBuffer.readBuffer(body), contentType);
    ...
    public void testAsMap() throws Exception {
        ...
        MediaType contentType = MediaTypes.valueOf("application/x-www-form-urlencoded; charset=UTF-8");
        params = new FormParameters(requestURI, DefaultReadableBuffer.readBuffer(body), contentType);
