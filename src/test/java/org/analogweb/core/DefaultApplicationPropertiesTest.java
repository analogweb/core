...
public class DefaultApplicationPropertiesTest {
    ...
    public void testUsingDefaultCreator() throws IOException {
        ...
        assertThat(properties.getTempDir().getPath(), startsWith(new File(
                SystemProperties.tmpDir() + SystemProperties.fileSeparator() + Application.class.getCanonicalName())
                        .getPath()));
    }
    ...
    public void testUsingArgsCreator() throws IOException {
        properties = DefaultApplicationProperties
                .properties(new String[] { "arg1", "arg2=arg3", "analogweb.tmpdir=/foo/baa/baz" });
        Collection<String> actualPackageNames = properties.getComponentPackageNames();
        assertThat(actualPackageNames.size(), is(1));
        assertThat(actualPackageNames.contains(Application.class.getPackage().getName()), is(true));
    ...
    public void testUsingConfiguredDefaultCreator() throws IOException {
        ...
        properties = DefaultApplicationProperties.properties(packageNames, tempDirectoryPath, locale);
        Collection<String> actualPackageNames = properties.getComponentPackageNames();
        ...
        assertThat(properties.getTempDir().getPath(), startsWith(
                new File(dir.getPath() + SystemProperties.fileSeparator() + Application.class.getCanonicalName())
                        .getPath()));
